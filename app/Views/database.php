...
$columnsToCreate = [
    ...
    ["column" => "language", "table" => "bot_follow_up", "type" => "VARCHAR", "constraint" => '250'],
    ["column" => "notified", "table" => "bot_follow_up", "type" => "VARCHAR", "constraint" => '250'],
    ["column" => "comment", "table" => "bot_follow_up", "type" => "TEXT", "constraint" => '2000'],
];
